...
class GameScene: SKScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        highestScoreLabel = childNodeWithName("//highestScoreLabel") as! SKLabelNode
        ...
        highestScore = defaults.integerForKey("highestScore")
    ...
    func gameOver() {
        ...
        defaults.setValue(score, forKey: "lastScore")
        ...
        // update the highest score it score is greater
    ...
    func displayMat(){
        let drop = SKAction(named: "MoveDown")!
        mat.runAction(drop)
    }
    func hideMat(){
        let moveUp = SKAction(named: "MoveUp")!
        mat.runAction(moveUp)
    }
